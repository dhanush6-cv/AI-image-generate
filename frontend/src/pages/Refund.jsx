        ...
        <div className="card">
          <div className="head">
            ...
            <h1 className="title neonFlicker">
              <span className="sweepText sweepSlow">Refund & Cancellation Policy</span>
            </h1>
            <p className="subtitle">
              This policy explains refund eligibility for premium plans & digital services.
            </p>
            <div className="meta">Last updated: {new Date().toLocaleDateString()}</div>
          </div>

          <div className="content">
            <Section title="1. Digital Service Nature">
              AI Image Studio provides digital image processing features and premium usage limits.
              Since output is delivered instantly, refunds are limited to specific cases below.
            </Section>

            <Section title="2. Eligible Refund Cases">
              Refunds may be granted if:
              <ul>
                <li>Payment was deducted but premium was not activated (and you contact us with proof).</li>
                <li>Duplicate payment happened for the same order/plan.</li>
                <li>Wrong amount was charged due to technical issue (verified by us).</li>
              </ul>
            </Section>
            ...
            <Section title="3. Non-Refundable Cases">
              ...
              <ul>
                <li>Premium benefits were already used (images processed / limits consumed).</li>
                <li>You changed your mind after purchase.</li>
                <li>Network issues / device issues from user side.</li>
              </ul>
            </Section>

            <Section title="4. Cancellation">
              Subscription cancellation (if applicable) stops future billing.
              Current billing period (current month) is usually non-refundable once benefits are used.
            </Section>

            <Section title="5. Refund Timeline">
              If approved, refunds are processed within <b>5–10 business days</b>.
              Actual credit time depends on bank / payment method.
            </Section>

            <Section title="6. How to Request a Refund">
              Email us with:
              <ul>
                <li>Registered email / UID</li>
                <li>Payment reference / Order ID</li>
                <li>Reason + screenshot (optional)</li>
              </ul>

              <div className="contactBox">
                <div><b>Support Email:</b> your-email@gmail.com</div>
                <div><b>Subject:</b> Refund Request - AI Image Studio</div>
              </div>

              Replace “dhanushkarthick610@gmail.com” with your real support mail.
            </Section>
          </div>
...
const css = `
  ...
  *{ box-sizing:border-box; }
  ...
  .meta{ margin-top: 10px; font-size: 12px; opacity: .75; }
  ...
  .secTitle{ font-weight: 1000; margin-bottom: 8px; letter-spacing: .2px; }
  .secBody{ font-size: 13.5px; line-height: 1.65; color: rgba(255,255,255,.84); }
  .secBody ul{ margin: 10px 0 0 18px; padding: 0; }
  ...
  .footer{ margin-top: 14px; display:flex; gap: 10px; justify-content:flex-end; flex-wrap:wrap; }
