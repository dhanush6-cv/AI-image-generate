      ...
      <div className="enhPage">
        ...
        <div className="card">
          <div className="titleRow">
            <h2 className="title neonFlicker">
              <span className="sweepText sweepSlow">4K AI Image Enhancer</span>
            </h2>
            <p className="subtitle">Upload an image and enhance it to a sharper 4K look.</p>
          </div>
          ...
          {!preview && (
            <div className="uploadRow">
              <div className="uploadBox" onClick={() => fileInputRef.current?.click()}>
                ...
                <div className="uploadMain">Click to Upload Image</div>
                <div className="uploadSub">JPG, PNG supported</div>
              </div>
            </div>
          )}
          ...
          {preview && (
            <div className="section">
              ...
              <button className="btnPrimary" onClick={handleEnhance} disabled={loading}>
                {loading ? (
            ...
            <div className="section result">
              <div className="resultHead">
                <div className="resultTitle">
                  <span className="sweepTextAlt sweepAlt">Enhanced Result</span>
                </div>
              </div>

              <div className="imgWrap">
                <img src={result} alt="Enhanced" className="img" />
              </div>

              <a className="downloadLink" href={result} download="enhanced-4k.png">
...
const css = `
  ...
  *{ box-sizing:border-box; }
  ...
  .uploadGlow{
    ...
    background:
      radial-gradient(420px 120px at 15% 20%, rgba(34,211,238,.16), transparent 65%),
      radial-gradient(420px 120px at 85% 10%, rgba(124,92,255,.16), transparent 65%),
      radial-gradient(420px 120px at 50% 110%, rgba(255,92,122,.10), transparent 65%);
    pointer-events:none;
  }
  .uploadMain{ position:relative; z-index:1; font-weight: 1000; font-size: 18px; }
  .uploadSub{ position:relative; z-index:1; margin-top: 6px; opacity:.80; font-size: 13px; }
